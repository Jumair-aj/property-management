...
export function DetailHeader({ property, saved, setSaved }: DetailHeaderProps) {
  return (
    <div className="gap-6 pb-8 border-b border-zinc-100">
      ...
      <div className="flex items-center gap-2.5 mt-5 select-none text-[13px] font-medium">
        <span className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-zinc-100 text-zinc-900 rounded-md whitespace-nowrap">
          <span className="w-1.5 h-1.5 bg-zinc-900 rounded-full" />
          Verified listing
        </span>
        <span className="inline-flex items-center px-3 py-1.5 bg-[#09090b] text-white rounded-md font-medium whitespace-nowrap">
          Managed by North
        </span>
