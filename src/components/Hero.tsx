  ...
  return (
    <section className="max-w-7xl mx-auto px-6 py-12 md:py-20 lg:py-24 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
      ...
      <div className="lg:col-span-6 w-full h-[320px] sm:h-[450px] lg:h-[580px] bg-zinc-100 relative group overflow-hidden border border-zinc-200">
        <div className="absolute inset-0 bg-gradient-to-tr from-zinc-200 via-zinc-100 to-zinc-50 flex flex-col items-center justify-center p-8 text-center">
          <svg className="w-12 h-12 text-zinc-300 mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="1">
            <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 15.75l5.159-5.159a2.25 2.25 0 013.182 0l5.159 5.159m-1.5-1.5l1.409-1.409a2.25 2.25 0 013.182 0l2.909 2.909m-18 3.75h16.5a1.5 1.5 0 001.5-1.5V6a1.5 1.5 0 00-1.5-1.5H3.75A1.5 1.5 0 002.25 6v12a1.5 1.5 0 001.5 1.5zm10.5-11.25h.008v.008h-.008V8.25zm.375 0a.375 0 11-.75 0 .375 0 01.75 0z" />
          </svg>
          <h3 className="text-sm font-semibold tracking-wide text-zinc-800 uppercase">Hero Image Placeholder</h3>
          <p className="text-zinc-400 text-xs mt-1 max-w-xs">Double-click or edit page.tsx to add your background/living room image</p>
        </div>
      </div>
    </section>
  );
